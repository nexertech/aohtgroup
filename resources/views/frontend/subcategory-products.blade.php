...
<div class="bg-gray-100 py-12">
    <div class="container-custom">
        ...
        <div class="mb-8 text-center">
            ...
            <p class="text-gray-600">Browse our products in this category</p>
        </div>
                        ...
                        <a href="{{ route('frontend.products.detail', $product->slug) }}">
                            <div class="h-48 bg-gray-200 overflow-hidden relative">
                                @if($product->main_image)
                                    <img src="{{ asset($product->main_image) }}" alt="{{ $product->product_name }}" class="w-full h-full object-cover group-hover:scale-110 transition-transform duration-500">
                                @else
        ...
        @else
            ...
            <div class="text-center py-20 bg-white rounded-lg shadow">
                ...
                <p class="mt-1 text-sm text-gray-500">Check back later for new products in this category.</p>
                <div class="mt-6">
