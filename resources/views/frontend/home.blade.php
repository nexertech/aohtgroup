...
<section class="categories-section">
  <div class="container-custom">
    ...
    <div class="flex justify-center mt-12">
        <a href="{{ route('frontend.categories') }}" class="inline-flex items-center justify-center px-8 py-3 border border-transparent text-base font-medium rounded-md text-white bg-indigo-600 hover:bg-indigo-700 md:py-4 md:text-lg md:px-10 transition duration-150 ease-in-out">
            Show More
