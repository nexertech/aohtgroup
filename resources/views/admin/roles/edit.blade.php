<x-admin-layout>
    <div class="container-fluid p-6">
        ...
        <div class="mb-6">
            ...
            <h1 class="text-2xl font-semibold text-gray-800 tracking-tight">Edit Role</h1>
            <p class="text-gray-500 text-sm mt-1">Update permissions for <span
                    class="text-indigo-600 font-bold tracking-tight">{{ $role->role_name }}</span></p>
        </div>
                ...
                <div class="p-6 md:p-8">
                    ...
                    <div class="mb-8">
                        ...
                        <input type="text" name="role_name" id="role_name"
                            ...
                            class="block w-full rounded-lg border-gray-200 bg-gray-50 focus:border-indigo-500 focus:ring-indigo-500 py-3 px-4 transition-all duration-200 shadow-sm"
                            placeholder="e.g. Administrator, Editor" required>
                        @error('role_name')
                    ...
                    <div>
                        <div class="flex items-center justify-between pb-4 border-b border-gray-100 mb-6">
                            <h4 class="text-sm font-bold text-gray-800 uppercase tracking-wider">Update Permissions</h4>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                            @foreach($permissions as $permission)
                                @php
                                    $isChecked = in_array($permission->permission_key, $role->permissions->pluck('permission_key')->toArray());
                                @endphp
                                <label
