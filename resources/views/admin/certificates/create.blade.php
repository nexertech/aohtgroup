...
@section('content')
    <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div class="flex justify-between items-center mb-6">
            <h1 class="text-2xl font-bold text-gray-900">Add New Certificate</h1>
        ...
        <div class="bg-white rounded-xl shadow-lg border border-gray-100 overflow-hidden p-6 relative">
            ...
            <form action="{{ route('admin.certificates.store') }}" method="POST" enctype="multipart/form-data"
                ...
                <!-- Image Field -->
                <div>
                    <label for="image" class="block text-sm font-semibold text-gray-700 mb-1">Certificate Image <span
