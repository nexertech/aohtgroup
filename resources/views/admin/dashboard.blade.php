                ...
                <div
                    ...
                    <div class="p-8">
                        <div class="flex items-center justify-between">
                            ...
                            <div
                                class="p-5 rounded-2xl bg-gradient-to-br from-indigo-500 to-purple-600 text-white shadow-lg shadow-indigo-500/30 group-hover:scale-110 transition-transform duration-300">
                        ...
                        <div class="mt-5 flex items-center text-sm text-slate-500">
                            ...
                            <span class="ml-2">tracking active</span>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="p-8">
                        ...
                        <div class="space-y-3">
                            ...
                            <a href="{{ route('admin.visitors.index') }}"
                                class="flex items-center w-full px-4 py-3 bg-white border-2 border-slate-200 text-slate-700 rounded-xl hover:border-emerald-300 hover:bg-emerald-50 hover:text-emerald-700 transition-all duration-300 font-medium">
                                <svg class="h-5 w-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                        d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z" />
                                </svg>
